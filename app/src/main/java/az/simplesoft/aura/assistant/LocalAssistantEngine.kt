...
class LocalAssistantEngine(
    ...
    private var dialogue = DialogueState()
    ...
    fun dialogueState(): DialogueState = dialogue
    ...
    private fun registryAction(match: IntentMatch, language: AssistantLanguage): AssistantReply? = when (match.intentId) {
    ...
    private fun decisionFromReply(reply: AssistantReply, input: NormalizedAssistantInput, match: IntentMatch?): AssistantDecision {
