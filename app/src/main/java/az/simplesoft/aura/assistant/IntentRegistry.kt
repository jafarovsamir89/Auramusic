...
class IntentRegistry(
    ...
    companion object {
        private fun defaultPatterns() = listOf(
            ...
            IntentPattern("open_local_library", examples = listOf("открой музыку на телефоне", "открой локальную музыку", "моя музыка на телефоне", "офлайн музыка", "open offline music", "phone music", "telefondakı musiqi"), priority = 100),
            IntentPattern("play_offline_music", examples = listOf("включи скачанную музыку", "включи офлайн музыку", "играй музыку с телефона", "play downloaded music", "play offline music", "yüklənmiş musiqini qoş"), priority = 100),
            IntentPattern("offline_status", examples = listOf("сколько песен скачано", "сколько музыки на телефоне", "offline library status", "telefonda neçə mahnı var"), priority = 100),
            IntentPattern("delete_all_offline", examples = listOf("удали всю офлайн музыку", "очисти офлайн библиотеку", "delete all offline music", "bütün oflayn musiqini sil"), priority = 100),
            IntentPattern("search_offline", examples = listOf("найди среди скачанных песен", "найди в офлайн музыке", "search offline music", "yüklənmiş mahnılarda axtar"), priority = 100),
            IntentPattern("download_current", examples = listOf("скачай эту песню", "сохрани песню офлайн", "добавь песню на телефон", "download this song", "save offline", "bu mahnını yüklə"), priority = 100),
            IntentPattern("download_queue", examples = listOf("скачай очередь", "скачай все песни из очереди", "сохрани очередь офлайн", "download the queue", "download all queued songs", "növbəni yüklə"), priority = 100),
            IntentPattern("delete_offline_current", examples = listOf("удали эту песню с телефона", "удали офлайн песню", "delete offline song", "bu mahnını telefondan sil"), priority = 100),
