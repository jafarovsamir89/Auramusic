...
class IntentRegistry(
    ...
    companion object {
        private fun defaultPatterns() = listOf(
            ...
            IntentPattern("next", examples = listOf("следующая", "следующий", "следующий трек", "дальше", "next", "next track", "novbeti mahni", "növbəti track"), priority = 90),
            IntentPattern("previous", examples = listOf("предыдущая", "предыдущий", "предыдущий трек", "назад", "previous", "previous track", "evvelki mahni", "əvvəlki mahnı"), priority = 90),
            IntentPattern("louder", examples = listOf("громче", "прибавь звук", "увеличь громкость", "turn it up", "volume up", "sesi artir"), priority = 90),
            IntentPattern("quieter", examples = listOf("тише", "убавь звук", "уменьши громкость", "turn it down", "volume down", "sesi azalt"), priority = 90),
